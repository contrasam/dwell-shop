...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dwell_shop`.`images` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dwell_shop`.`property_images` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dwell_shop`.`buyable_properties` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dwell_shop`.`bids` ;
